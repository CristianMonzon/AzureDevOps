...
{
    public class WorkItemQueryExecutor : BaseQueryExecutor
    {
        ...
        /// <param name="iteration">The name of your iteration within your organization.</param>
        /// <returns>A list of <see cref="WorkItem"/> objects representing all the open bugs.</returns>
        public async Task<IList<WorkItem>> AllWorkItems(string project, string iteration)
        {
        ...
        /// <param name="project">The name of your project within your organization.</param>
        /// <returns>A list of <see cref="WorkItem"/> objects representing all the open bugs.</returns>
        public async Task<IList<WorkItem>> IssueWorkItems(string project, string iteration)
        {
            var credentials = new VssBasicCredential(string.Empty, PersonalAccessToken);
